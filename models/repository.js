...
class Repository {
    ...
    getAll(params = null) 
    {
        ...
        if (params) 
        {
            ...
            for (let objet of objectsList) 
            {
                for (let searchKey of searchKeys) 
                {
                    if (objet[searchKey.key] === searchKey.value || this.valueMatch(objet[searchKey.key], searchKey.value)) {
                        filteredAndSortedObjects.push(objet)
                    }
                }
            }
